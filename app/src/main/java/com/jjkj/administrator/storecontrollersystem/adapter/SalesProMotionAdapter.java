 ...
 * @description
 */
public class SalesProMotionAdapter extends BaseQuickAdapter<SalesSlip, BaseViewHolder> {
	public SalesProMotionAdapter(int layoutResId, @Nullable List<SalesSlip> data) {
